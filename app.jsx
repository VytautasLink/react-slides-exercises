...
var ProductListPage = function( props ) {
    return ( <ProductListComponent products={testProducts} />
    );
};
var AdministrationPage = function( props ) {
    return ( <ProductListComponent products={ProductListComponent} />
    );
};
...
ReactDOM.render((
    ...
    <Router history={hashHistory}>
        <Route path="/" component={App}>
            ...
            <Route path="/administration" component={ProductAdministrationComponent} />
