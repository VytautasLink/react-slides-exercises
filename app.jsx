    ...
    <div >
        ...
        <form>
            <div className="form-group">
                <label>Title</label>
                <input className="form-control" value={this.props.title} onChange={this.onTitleChange} />
            </div>
            <div className="form-group">
                <label>Image url</label>
                <input className="form-control" value={this.props.image} onChange={this.onImageChange} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
                <label>Price</label>
                <input className="form-control" value={this.props.price} onChange={this.onPriceChange} />
            </div>
            <div className="form-group">
...
var ProductAdministrationContainer = React.createClass( {
    ...
    render: function() {
        ...
        return (<ProductAdministrationComponent prop1={this.state.prop1} />
                );
    }
});
